<template>
  <div class="row mt-3">
    <vueHeadful
      title="Разработка"
      description="Ссылки на качественные материалы по веб-разработке. Данная информация бедет полезна не только веб-разработчикам, но и тем, кто желает расширить свой кругозор"
    />
    <div class="col-12">
      <h3>Разработка</h3>
            ...
            <div class="card-body">
              ...
              <ul class="pl-4 mb-1">
                <li>
                  <a
                    title="Открыть сайт"
                    href="https://ru.hexlet.io/pages/recommended-books/?ref=107231"
                    target="_blank"
                  >Список hexlet.io</a>
                </li>
                <li>
                  <a
                    title="Открыть сайт"
                    href="https://learn.javascript.ru/books"
                    target="_blank"
                  >Список learn.javascript.ru</a>
                </li>
                <li>
                  <a
                    title="Открыть сайт"
                    href="https://stackoverflow.com/questions/1711/what-is-the-single-most-influential-book-every-programmer-should-read"
                    target="_blank"
                  >stackoverflow.com (en)</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="card shadow-sm red-border">
            <div class="card-body">
              ...
              <ul class="pl-4 mb-1">
                <li>
                  <a
                    href="https://www.youtube.com/channel/UCg8ss4xW9jASrqWGP30jXiw/playlists"
                    target="_blank"
                    title="Открыть сайт"
                  >Владилен Минин</a>
                </li>
                <li>
                  <a
                    href="https://www.youtube.com/user/ArtSorax/playlists"
                    target="_blank"
                    title="Открыть сайт"
                  >Sorax</a>
                </li>
      ...
      <p>
        ...
        <a
          ...
          href="http://16-bits.ru/myvideo/nettech/"
          target="_blank"
          ...
          <div class="card shadow h-100 card-redact">
            ...
            <div class="card-footer pt-0 pb-3 bg-white border-0">
              <a
                ...
                class="btn btn-block btn-sm btn-danger stretched-link rounded-pill"
                target="_blank"
              >Перейти</a>
            </div>
          </div>
